...
_Source: system-design-primer: availability patterns, real-world architectures._

SLOs, health checks, alerting, logs, metrics, tracing, graceful degradation, and failure drills.

## What You Build

Implement a health dashboard that aggregates service status, error rate, and latency buckets.
