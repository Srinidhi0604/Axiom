...
_Source: system-design-primer: content delivery network._

Push vs pull CDNs, edge caching, invalidation, static assets, and global latency reduction.

## What You Build

Design and implement a static asset URL signer with cache-control headers and purge simulation.
