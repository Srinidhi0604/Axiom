...
_Source: system-design-primer: powers of two, latency numbers, study guide._

Capacity estimates, powers of two, storage math, QPS, bandwidth, and interview sizing habits.

## What You Build

Build a capacity calculator for reads, writes, storage, cache size, and network bandwidth.
