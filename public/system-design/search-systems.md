...
_Source: system-design-primer: real-world architectures and search-oriented design prompts._

Inverted indexes, ranking, autocomplete, write pipelines, indexing lag, and query fanout.

## What You Build

Implement a tiny inverted index with prefix search and simple term-frequency ranking.
