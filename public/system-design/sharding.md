...
_Source: system-design-primer: sharding, federation._

Range, hash, directory-based sharding, hot partitions, rebalancing, and shard key selection.

## What You Build

Implement hash-based routing for users across shards and simulate a resharding event.
