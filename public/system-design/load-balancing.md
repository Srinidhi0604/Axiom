...
_Source: system-design-primer: load balancer, horizontal scaling._

Layer 4 vs Layer 7, active-active, active-passive, health checks, and horizontal scaling.

## What You Build

Implement round-robin, weighted round-robin, and least-connections routing over mock servers.
