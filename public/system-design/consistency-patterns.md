...
_Source: system-design-primer: CAP theorem, consistency patterns._

CAP, weak consistency, eventual consistency, strong consistency, and user-facing tradeoffs.

## What You Build

Implement a eventually consistent like counter with conflict resolution and reconciliation.
