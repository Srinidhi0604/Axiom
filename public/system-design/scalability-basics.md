...
_Source: system-design-primer: performance vs scalability, latency vs throughput._

Performance vs scalability, latency vs throughput, and the first-principles vocabulary from system-design-primer.

## What You Build

Implement a tiny load simulator that measures p50, p95, p99 latency for a mock API.
