...
_Source: system-design-primer: security, availability, cache primitives._

Fixed window, sliding window, token bucket, leaky bucket, distributed counters, and abuse protection.

## What You Build

Implement token bucket and sliding-window rate limiters with per-user and per-IP keys.
