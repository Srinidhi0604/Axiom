...
_Source: system-design-primer: how to approach a system design interview question._

A repeatable interview method: requirements, API, data model, high-level design, bottlenecks, and tradeoffs.

## What You Build

Complete one end-to-end design: URL shortener, news feed, chat, file store, or metrics system.
