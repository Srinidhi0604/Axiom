...
_Source: system-design-primer: replication, fail-over._

Master-slave, master-master, failover, read replicas, replication lag, and availability patterns.

## What You Build

Implement primary-replica writes with async replication lag and read-your-writes toggle.
